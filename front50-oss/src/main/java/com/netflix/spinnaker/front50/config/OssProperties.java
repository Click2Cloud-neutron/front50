...
public class OssProperties extends OssBucketProperties {
  String rootFolder;

  @NestedConfigurationProperty
  OssFailoverProperties failover = new OssFailoverProperties();

  @NestedConfigurationProperty
  OssEventingProperties eventing = new OssEventingProperties();

  // Front50 retrieves objects in batches of this size. Some Oss compatible store enforce a maximum number of keys
  ...
  public OssFailoverProperties getFailover() {
    return failover;
  }

  public void setFailover(OssFailoverProperties failover) {
  ...
  public OssEventingProperties getEventing() {
    return eventing;
  }

  public void setEventing(OssEventingProperties eventing) {
