...
public class OssBucketProperties {
  ...
  // regionOverride allows the aws client to override the region in oss request signatures
  // some oss compatible solutions allow non-aws region identifiers to be used
